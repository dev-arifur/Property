(function(global, factory) {
    ...
    var element_arc = core_element.extend({
        ...
        draw: function() {
            ...
            var eA = vm.endAngle;
            var pixelMargin = vm.borderAlign === "inner" ? .33 : 0;
            var angleMargin;
            ctx.save();
            ctx.beginPath();
            ...
            helpers$1.each(ticks, function(tick, index) {
                ...
                if (isHorizontal) {
                    ...
                    if (position === "top") {
                        ...
                        y2 = chartArea.bottom;
                        textOffset = ((!isRotated ? .5 : 1) - labelCount) * lineHeight;
                        textAlign = !isRotated ? "center" : "left";
                        labelY = me.bottom - labelYOffset
                    } else {
                        y1 = chartArea.top;
                        y2 = alignPixel(chart, chartArea.bottom, axisWidth) - axisWidth / 2;
                        textOffset = (!isRotated ? .5 : 0) * lineHeight;
    ...
    function generateTicks(generationOptions, dataRange) {
        ...
        if (stepSize) {
            if (!isNullOrUndef(min) && helpers$1.almostWhole(min / spacing, spacing / 1e3)) {
                niceMin = min
            }
            if (!isNullOrUndef(max) && helpers$1.almostWhole(max / spacing, spacing / 1e3)) {
                niceMax = max
            }
        }
    ...
    function drawPointLabels(scale) {
        ...
        if (ctx.setLineDash) {
            ...
            ctx.lineDashOffset = resolve$7([angleLineOpts.borderDashOffset, gridLineOpts.borderDashOffset, 0])
        }
